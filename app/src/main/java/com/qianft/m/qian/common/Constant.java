...
public class Constant {
	...
	public static final String LATEST_VERSION_DOWNLOAD = SERVER + "app/GetAppAPK";

	public static final String ERROR_MSG_POST_URL = SERVER + "App/SubmitAppLog";
	public static final String GET_ALL_ALLOW_URL = "http://app.qianft.com/app/getfilterurllist";

	public static final String USER_LOGIN_URL = SERVER + "UserLogin";
